...
submissions = Table(
    ...
    Column("asrs_part_a_sum", Integer),
    Column("asrs_part_b_sum", Integer),
...
def save_submission(
    ...
    row = {
        ...
        "asrs_part_a_sum": metric("asrs", "part_a_sum"),
        "asrs_part_b_sum": metric("asrs", "part_b_sum"),
        "asrs_total_raw": metric("asrs", "total_score"),
